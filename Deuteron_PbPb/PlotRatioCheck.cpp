...
void PlotRatioCheck(const char *cutSettings="", const char *outFileName = "RatioCheckPlot", const char *histoNameDir = "", const char *outFileOption = "recreate", const char *inFileRatioName = "SpectraDeuteronNoPrimary", const char *inFilePrimaryName = "PrimaryDeuteron")
{
  gStyle->SetOptStat(0);
  ...
  {
    TCanvas cRatioCheck(Form("cRatioCheck_%.0f_%.0f", kCentBinsLimitsDeuteron[iCent][0], kCentBinsLimitsDeuteron[iCent][1]), Form("cRatioCheck_%.0f_%.0f", kCentBinsLimitsDeuteron[iCent][0], kCentBinsLimitsDeuteron[iCent][1]));
    ...
    auto fRatioCheck = (TH1D *)inFileRatio->Get(Form("./fRatio_%.0f_%.0f", kCentBinsLimitsDeuteron[iCent][0], kCentBinsLimitsDeuteron[iCent][1]));
    fRatioCheck->SetTitle(Form("%.0f-%.0f%%", kCentBinsLimitsDeuteron[iCent][0], kCentBinsLimitsDeuteron[iCent][1]));
