...
bdt_score = bdt_score_dict["matter_0_5_7_14"]
...
#bdt_score_2 = bdt_score_dict_2["matter_0_5_7_14"]
...
plt.title(r"$0-5\%, 7\leq c\mathrm{t} < 14\ \mathrm{cm}$")
plt.ylim([0.,1.1])
plt.grid()
plt.savefig("BDT_eff_score_0_5_7_ct_14_cm.pdf")