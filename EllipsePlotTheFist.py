...
text.SetTextSize(24)
text.DrawLatex(0.175,1.1,"Pb#minusPb")
text.DrawLatex(0.175,0.9,"#sqrt{#it{s}_{NN}} = 5.02 TeV")
text.DrawLatex(0.85,1.3,"Thermal-FIST")
text.DrawLatex(0.85,1.1,"#it{T}_{ch} = 155 #pm 2 MeV")
text.DrawLatex(0.85,0.9,"#it{#mu}_{S} constrained")
#text.SetTextSize(28)
