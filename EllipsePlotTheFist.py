...
# h_frame.GetYaxis().SetTitleFont(44)
# h_frame.GetYaxis().SetTitleSize(25)
h_frame.GetYaxis().SetTitleOffset(1.4)
h_frame.GetYaxis().SetLabelFont(44)
h_frame.GetYaxis().SetLabelSize(25)
h_frame.GetYaxis().SetLabelOffset(0.013)
# h_frame.GetXaxis().SetTitleFont(44)
# h_frame.GetXaxis().SetTitleSize(25)
# h_frame.GetXaxis().SetTitleOffset(1.)
h_frame.GetXaxis().SetLabelFont(44)
h_frame.GetXaxis().SetLabelSize(25)
h_frame.GetXaxis().SetLabelOffset(0.009)
...
text.SetTextSize(29)
text.DrawLatex(0.2,0.83,"Pb#minusPb, #sqrt{#it{s}_{NN}} = 5.02 TeV")
text.DrawLatex(0.2,0.45,"Thermal-FIST")
text.DrawLatex(0.2,0.38,"#it{T}_{ch} = 155 #pm 2 MeV")
text.DrawLatex(0.2,0.31,"#it{#mu}_{S} constrained")
#text.SetTextSize(28)
...
legErr.SetTextSize(25)
legErr.AddEntry(ellipses[5],"Uncorr. uncert.", "l")
