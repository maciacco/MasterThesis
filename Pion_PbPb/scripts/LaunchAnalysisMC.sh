...
# fileData="LHC20e3a"
# fileMC="LHC20e3a"
signalName="SignalPionMC_21l5_false_"
spectraName="SpectraPionMC_21l5_false"
...
.L EfficiencyNew.cpp+
//.L Spectra.cpp+
SignalBinnedMC("$cutSettings",1.5,11.,8.5,13.5,$argumentSignal,"$fileData","$signalName","recreate")
