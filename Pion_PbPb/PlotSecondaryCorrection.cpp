...
void PlotSecondaryCorrection(const char *inFileRooFitName = "PrimaryPionRoo", const char *inFileTFFName = "PrimaryPion", const char *outFileCompareName = "PrimaryCompareRooFitTFF", const char *inFileSpectraTFFName = "SpectraPion_MC21l5_raw", const char* inFileSpectraRooName = "SpectraPion_MC21l5_raw_ROO"){
  ...
  for (int iC = 0; iC < kNCentClasses; ++iC){
    ...
    for (int iM = 0; iM < 2; ++iM) {
      ...
      hPrimaryRatio.SetName(Form("f%sPrimaryRatio_%.0f_%.0f",kAntimatterMatter[iM],kCentBinsLimitsPion[iC][0],kCentBinsLimitsPion[iC][1]));
    ...
    hDivideTFF.SetName(Form("fDivideTFF_%.0f_%.0f",kCentBinsLimitsPion[iC][0],kCentBinsLimitsPion[iC][1]));
    ...
    hDivideRooFit.SetName(Form("fDivideRooFit_%.0f_%.0f",kCentBinsLimitsPion[iC][0],kCentBinsLimitsPion[iC][1]));
    ...
    TH1D *hRatioTFF = (TH1D*)inFileSpectraTFF.Get(Form("fRatio_%.0f_%.0f",kCentBinsLimitsPion[iC][0],kCentBinsLimitsPion[iC][1]));
    TH1D *hRatioRoo = (TH1D*)inFileSpectraRoo.Get(Form("fRatio_%.0f_%.0f",kCentBinsLimitsPion[iC][0],kCentBinsLimitsPion[iC][1]));
