...
void PlotEfficienciesDifferential(const char *cutSettings="", const char *outFileName = "EfficiencyPlotsDifferential", const char *histoNameDir = "", const char *outFileOption = "recreate", const char *inFile = "EfficiencyPionMC_21l5_false_")
{
  ...
  for (int iMatt = 0; iMatt < 2; iMatt++)
  {
    ...
    for (int iCent = 0; iCent < kNCentClasses; ++iCent)
    {
      ...
      fEff[iCent]->GetXaxis()->SetRangeUser(0.5, 0.89);
