...
pad2.Draw()
pad1.cd()
l = ROOT.TLegend(0.44,0.53,0.7,0.95)
l.SetTextFont(44)
l.SetTextSize(15)
frame.Draw()
#g1.Fit(param)
pad1.cd()
pad3 = ROOT.TPad("pad3", "pad3", 0.43, 0.05, 0.93, 0.53)
pad3.SetFillColor(0)
...
frame3.GetXaxis().SetLabelSize(14)
frame3.GetYaxis().SetLabelFont(44)
frame3.GetYaxis().SetLabelSize(14)
frame3.Draw()
