...
input_eff_r_material = ROOT.TFile.Open("out/EfficiencyProtonMC_21l5_false___LHC22b9.root")
input_eff_std_material = ROOT.TFile.Open("out/EfficiencyProtonMC_21l5_false___LHC22b9_2.root")

cent = [[0,5],[5,10],[30,50],[999,999]]
matt = [["A","antiproton"],["M","proton"]]
outlier = [2.15,2.9]
