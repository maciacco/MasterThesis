...
void PlotSpectraMatterAntimatter(const char *cutSettings = "", const char *outFileName = "SpectraMatterAntimatter", const char *histoNameDir = "", const char *outFileOption = "recreate", const char *inFile = "SpectraProton")
{
  gStyle->SetOptStat(0);
  ...
  {
    TCanvas c(Form("fSpectraCompareAntimatterMatter_%.0f_%.0f", kCentBinsLimitsProton[iC][0], kCentBinsLimitsProton[iC][1]),Form("fSpectraCompareAntimatterMatter_%.0f_%.0f", kCentBinsLimitsProton[iC][0], kCentBinsLimitsProton[iC][1]));
    TLegend l(0.575188, 0.696491, 0.913534, 0.861404);
    l.SetHeader(Form("Centrality %.0f-%.0f%%", kCentBinsLimitsProton[iC][0], kCentBinsLimitsProton[iC][1]));
    c.cd();
    for (int iMatt = 0; iMatt < 2; ++iMatt)
    {
      spectra[iMatt]=(TH1D*)inFileSpectra->Get(Form("_1_1_1/f%sSpectra_%.0f_%.0f", kAntimatterMatter[iMatt], kCentBinsLimitsProton[iC][0], kCentBinsLimitsProton[iC][1]));
